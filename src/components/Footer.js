...
<footer>
  <div className="container">
    ...
    className="f-header">
      ...
      <nav>
        <ul>
          <li><a target="_blank" aria-label='view my github' rel="noopener noreferrer" href="https://github.com/giorgi583"><i className="fa-brands fa-github"></i></a></li>
          <li><a target="_blank" aria-label='view my frontend' rel="noopener noreferrer" href="https://www.frontendmentor.io/profile/giorgi583" className="frontend"><img
                src={theme === "dark" ? assets.frontend : assets.frontendBlack} alt="frontend icon" width="19.68"/></a></li>
          <li><a target="_blank" aria-label='view my linkedin' rel="noopener noreferrer" href="https://www.linkedin.com/in/giorgi-kutateladze-45086323b/"><i
                className="fa-brands fa-linkedin"></i></a></li>
          <li><a target="_blank" aria-label='view my facebook' rel="noopener noreferrer" href="https://www.facebook.com/giorgi.kutateladze.14"><i
